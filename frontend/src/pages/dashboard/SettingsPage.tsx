...
const SettingsPage: React.FC = () => {
  ...
  const Toggle = ({ on, onToggle }: { on: boolean; onToggle: () => void }) => (
    <button
      onClick={onToggle}
      className={
        'relative inline-flex items-center h-6 rounded-full w-11 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 ' +
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-16">
            <button
              ...
              className="mr-4 p-2 rounded-lg text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
            >
              <Settings className="h-5 w-5" />
            </button>
            <div>
              <h1 className="text-xl font-bold text-gray-900 dark:text-white">Paramètres</h1>
              <p className="text-sm text-gray-500 dark:text-gray-400">Gérez vos préférences et votre compte</p>
            </div>
          </div>
        </div>
      </div>
                ...
                {sections.map(({ id, name, icon: Icon }) => (
                  <button
                    ...
                    className={
                      ...
                      (activeSection === id
                        ? 'bg-blue-50 dark:bg-blue-950/50 text-blue-700 dark:text-blue-300 border-l-4 border-blue-700'
            ...
            <div className="space-y-6">
              ...
              {message && (
                <div className={
                  ...
                  (messageType === 'success' ? 'bg-green-50 dark:bg-green-950/40 text-green-800 dark:text-green-200 border-green-400'
                    : messageType === 'error' ? 'bg-red-50 dark:bg-red-950/40 text-red-800 dark:text-red-200 border-red-400'
                    : 'bg-yellow-50 dark:bg-yellow-950/40 text-yellow-800 dark:text-yellow-200 border-yellow-400')
                }>
                ...
                <>
                  ...
                  <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    <div className="flex items-center mb-6">
                      ...
                      <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Paramètres du compte</h2>
                    </div>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full px-3 py-2 pr-10 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400">Activer le thème sombre pour l'interface</p>
                        </div>
                      </div>
                ...
                <div className="space-y-6">
                  <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <button className="p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-left">
                        <HelpCircle className="h-6 w-6 text-blue-600 mb-2" />
                        <h3 className="text-sm font-medium text-gray-900">Centre d'aide</h3>
                        <p className="text-xs text-gray-500 dark:text-gray-400">Articles et tutoriels</p>
                      </button>
                      <button className="p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-left">
                        <Mail className="h-6 w-6 text-blue-600 mb-2" />
                        <h3 className="text-sm font-medium text-gray-900">Nous contacter</h3>
                        <p className="text-xs text-gray-500 dark:text-gray-400">Support par email</p>
                      </button>
                      <button className="p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-left">
                        <Info className="h-6 w-6 text-blue-600 mb-2" />
                        <h3 className="text-sm font-medium text-gray-900">À propos</h3>
                        <p className="text-xs text-gray-500 dark:text-gray-400">Informations sur l'application</p>
                      </button>
                    </div>
                  </div>

                  <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    <h3 className="text-md font-semibold text-gray-900 dark:text-white mb-4">À propos de l'application</h3>
              ...
              <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-red-200 dark:border-red-900/50 p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 border border-red-200 dark:border-red-800 rounded-lg bg-red-50 dark:bg-red-950/40">
                    <div>
                      <h3 className="text-sm font-medium text-gray-900">Déconnexion</h3>
                      <p className="text-xs text-gray-500 dark:text-gray-400">Se déconnecter de votre compte</p>
                    </div>
                    <button
                  ...
                  <div className="flex items-center justify-between p-4 border border-red-200 dark:border-red-800 rounded-lg bg-red-50 dark:bg-red-950/40">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">Supprimer définitivement votre compte</p>
                    </div>
                    <button
